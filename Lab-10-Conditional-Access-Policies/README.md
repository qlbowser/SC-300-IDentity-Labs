...
![Sway Access Before Conditional Access](images/01-Sway-Access-Before-Conditional-Access.png)

### 2. Conditional Access Policy Enabled
![Conditional Access Policy Enabled](images/02-Conditional-Access-Policy-Enabled.png)

### 3. Conditional Access Successfully Blocked Sway
![Conditional Access Successfully Blocked Sway](images/03-Conditional-Access-Successfully-Blocked-Sway.png)

### 4. Conditional Access What If Analysis
![Conditional Access What If Analysis](images/04-Conditional-Access-What-If-Analysis.png)

### 5. Sign-in Frequency Policy in Report-Only Mode
![Sign-in Frequency Policy](images/05-Sign-in-Frequency-Policy-in-Report-Only-Mode.png)
